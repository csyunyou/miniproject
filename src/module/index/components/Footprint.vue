    ...
    <div class="footprint">
        ...
        <div class="record-wrapper">
            ...
            <div class="recordTable">
                <el-table :data="tableData.slice((currentPage-1)*pageSize,(currentPage-1)*pageSize+pageSize)" style="width: 100%">
                    <el-table-column prop="title" label="标题" sortable width="180">
                    </el-table-column>
                    <el-table-column prop="type" label="类型" width="180">
                    </el-table-column>
                    <el-table-column prop="category" label="类别" width="100" :filters="filterOpts" :filter-method="filterTag" filter-placement="bottom-end">
...
export default {
    data() {
        ...
        methods: {
            ...
            pieDataAdapter(data) {
                let categoryGroup = _.countBy(data, 'category'),
                    res = []
        ...
        mounted() {
            ...
            this.pieData = this.pieDataAdapter(this.tableData)
            this.drawPieChart()
        }
}
</script>
